{{--
    ...
    COMPONENT: Track Another Order

    DESCRIPTION:
    Search form allowing customers to look up an order
    using Order ID or Tracking Number.
    ...
    - Replace form action with route('orders.track')
    - Replace method with POST
    - Wire to OrderController@search()
